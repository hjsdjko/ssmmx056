  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
	    ...
	    <download-excel v-if="isAuth('xueshengqiandao','导出')" class = "export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "学生签到.xls">
		      <!-- 导出excel -->
            	<el-button
...
//导出excel
      json_fields: {
      "签到编号": "qiandaobianhao",    //常规字段
      "签到类型": "qiandaoleixing",    //常规字段
      "图片": "tupian",    //常规字段
      "时间": "shijian",    //常规字段
