...
public class XueshengqiandaoController {
    ...
    public R page(@RequestParam Map<String, Object> params,XueshengqiandaoEntity xueshengqiandao, 
		...
		if(tableName.equals("xuesheng")) {
			xueshengqiandao.setXueshengzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jiaoshi")) {
			xueshengqiandao.setJiaoshigonghao((String)request.getSession().getAttribute("username"));
		}
